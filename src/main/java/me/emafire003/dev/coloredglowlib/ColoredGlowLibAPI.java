...
public class ColoredGlowLibAPI {
	 ...
	 *                 or <b>"random"</b> to make a random color each tick.
	 *                 It can also be a custom color animation name added by a datapack
	 * @param colorViewer The only Team who will see the specified color
	 */
	public void setExclusiveColorForTeam(Entity target, String color, Team colorViewer){
		ColorComponent component = COLOR_COMPONENT.get(target);
		component.setExclusiveColorForTeam(colorViewer.getName(), color);
	}
